 ...
 * - Opalite blue accent on active/hover states
 */
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex h-16 items-center justify-between md:h-20">
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-lg text-foreground glass-btn-icon md:hidden"
              ...
              {navLinks.map((link, index) => (
                ...
                >
                  <a
                    href={link.href}
                    onClick={(e) => handleNavClick(e, link.href)}
                    className="text-2xl font-medium text-foreground transition-colors hover:text-opalite-400"
                  >
                    {link.label}
                  </a>
                </motion.li>
